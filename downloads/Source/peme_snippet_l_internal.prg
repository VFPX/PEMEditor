...
Function Process
	...
	Local laFields[1], lcFieldName, lcHTMLHeader, lcOpenFilePRG, lcResult, lcText, lcThisPRG, lcType
	Local lnDecimals, lnFieldCount, lnI, lnWidth
	...
	If Not Used (lcFileName)
		...
		If File (lcOpenFilePRG)
			...
			Endif
		Else
			Messagebox ('[' + lcFileName + '] not found')
			Return .T. && mine, nothing to change
		Endif
	Endif
...
<table border="1">
	...
	Do Form PEME_Help_Internal With 'Layout for ' + lcFileName, lcHTMLHeader + lcResult, 300, 600
